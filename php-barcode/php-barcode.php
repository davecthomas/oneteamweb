...
if (file_exists(getenv('windir'))){
    $font_loc=getenv('windir')."\Fonts\arialbd.ttf";
}
 ...
 */
//$genbarcode_loc=system_wwwroot."php-barcode\genbarcode.exe";
$genbarcode_loc="C:\inetpub\wwwroot\\1team\php-barcode\genbarcode.exe";
...
function barcode_print($code, $encoding="ANY", $scale = 1 ,$mode = "png" ){
